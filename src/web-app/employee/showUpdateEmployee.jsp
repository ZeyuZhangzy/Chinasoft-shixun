...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tbody><tr valign="top">
    <td>
    	<form action="updateEmployee" name="EmployeeForm">
			<!-- 隐藏表单，flag表示添加标记 -->
		  <table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tbody><tr valign="top">
    <td>
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tbody><tr><td class="font3 fftd">
		    	<table>
		    		<tbody><tr>
		    			...
		    			<td class="font3 fftd">身份证号码：<input type="text" name="identity" id="identity" size="20" value="${employee.identity}"></td>
		    		</tr>
		    		<tr>
		    			...
		    			<td class="font3 fftd">职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位：
		    			 	<select id="pid" name="pid" style="width:143px;">
		    		...
		    		<tr>
		    			<td class="font3 fftd">学历：<input name="record" id="record" size="20" value="${employee.record}"></td>
		    			<td class="font3 fftd">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：<input name="email" id="email" size="20" value="${employee.email}"></td>
		    		</tr>
		    		<tr>
		    			<td class="font3 fftd">手机：<input name="telphone" id="telphone" size="20" value="${employee.telphone}"></td>
		    			<td class="font3 fftd">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：<input name="phone" id="phone" size="20" value="${employee.phone}"></td>
		    		</tr>
			...
			<tr>
				<td class="font3 fftd">
					政治面貌：<input name="politic" id="politic" size="40" value="${employee.politic}">&nbsp;&nbsp;
			...
			<tr>
				<td class="font3 fftd">
					...
					邮政编码：<input name="postalcode" id="postalcode" size="20" value="${employee.postalcode}">
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					出生日期：<input  value="${employee.birthday}" cssclass="Wdate" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'});" name="birthday" id="birthday" size="40">&nbsp;&nbsp;
					民&nbsp;&nbsp;&nbsp;&nbsp;族：<input name="nation" id="nation" size="20" value="${employee.nation}">
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					爱&nbsp;&nbsp;&nbsp;&nbsp;好：<input name="habby" id="habby" size="20" value="${employee.habby}">
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					备&nbsp;&nbsp;&nbsp;&nbsp;注：<input name="note" id="note" size="40" value="${employee.note}">
					&nbsp;&nbsp;所属部门：
